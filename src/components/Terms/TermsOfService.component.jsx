...
function TermsOfService() {
  return (
    <div>
      ...
      <p>
        By accessing this Website, accessible from MiningStats.com, you are
      ...
      <p>
        ...
        on MockSite's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on MockSite's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let MockSite to terminate upon violations of any of these
      ...
      <p>
        All the materials on MockSite’s Website are provided "as is". MockSite
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, MockSite does not make any
      ...
      <p>
        MockSite or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        MockSite’s Website, even if MockSite or an authorize representative of
      ...
      <p>
        The materials appearing on MockSite’s Website may include technical,
        typographical, or photographic errors. MockSite will not promise that
        any of the materials in this Website are accurate, complete, or current.
        MockSite may change the materials contained on its Website at any time
        without notice. MockSite does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        MockSite has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by MockSite of the site. The use
      ...
      <p>
        MockSite may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to MockSite's Website shall be governed by the laws of
